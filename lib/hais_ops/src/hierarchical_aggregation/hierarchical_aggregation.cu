...
__global__ void fragment_find_primary_(int primary_num, int *cuda_primary_offsets, float *cuda_primary_centers,
    ...
    float class_radius_mean[13] = {3.09752068, 3.6805359 , 2.24846915, 1.71799748, 1.42457958,
       1.52959682, 1.43950354, 0.5872468 , 1.3165617 , 1.20147934,
       0.87942664, 1.17570155, 0.70954275};
